...
-- -----------------------------------------------------
-- Table `luxury_car_rental`.`Maintainence`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `luxury_car_rental`.`Maintainence` (
  ...
  CONSTRAINT `fk_Maintainence_Staff1`
    FOREIGN KEY (`Staff_staff_id`)
    REFERENCES `luxury_car_rental`.`Staff` (`staff_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `luxury_car_rental`.`Vehicles` (
  ...
  `Maintainence_maintenance_id` INT NOT NULL,
  `Maintainence_Staff_staff_id` INT NOT NULL,
  PRIMARY KEY (`vehicle_id`, `Customer_customer_id`, `Insurance_insurance_id`, `Maintainence_maintenance_id`, `Maintainence_Staff_staff_id`),
  ...
  INDEX `fk_Vehicles_Maintainence1_idx` (`Maintainence_maintenance_id` ASC, `Maintainence_Staff_staff_id` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_Vehicles_Maintainence1`
    FOREIGN KEY (`Maintainence_maintenance_id` , `Maintainence_Staff_staff_id`)
    REFERENCES `luxury_car_rental`.`Maintainence` (`maintenance_id` , `Staff_staff_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `luxury_car_rental`.`purchase` (
  ...
  `Vehicles_Maintainence_maintenance_id` INT NOT NULL,
  `Vehicles_Maintainence_Staff_staff_id` INT NOT NULL,
  `Loan_loan_id` INT NOT NULL,
  PRIMARY KEY (`Vehicles_vehicle_id`, `Vehicles_Customer_customer_id`, `Vehicles_Insurance_insurance_id`, `Vehicles_Maintainence_maintenance_id`, `Vehicles_Maintainence_Staff_staff_id`, `Loan_loan_id`),
  INDEX `fk_Vehicles_has_Loan_Loan1_idx` (`Loan_loan_id` ASC) VISIBLE,
  INDEX `fk_Vehicles_has_Loan_Vehicles1_idx` (`Vehicles_vehicle_id` ASC, `Vehicles_Customer_customer_id` ASC, `Vehicles_Insurance_insurance_id` ASC, `Vehicles_Maintainence_maintenance_id` ASC, `Vehicles_Maintainence_Staff_staff_id` ASC) VISIBLE,
  CONSTRAINT `fk_Vehicles_has_Loan_Vehicles1`
    FOREIGN KEY (`Vehicles_vehicle_id` , `Vehicles_Customer_customer_id` , `Vehicles_Insurance_insurance_id` , `Vehicles_Maintainence_maintenance_id` , `Vehicles_Maintainence_Staff_staff_id`)
    REFERENCES `luxury_car_rental`.`Vehicles` (`vehicle_id` , `Customer_customer_id` , `Insurance_insurance_id` , `Maintainence_maintenance_id` , `Maintainence_Staff_staff_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
